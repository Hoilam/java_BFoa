...
<style type="text/css">
	...
	a:HOVER {font-size: 12px;text-decoration: underline; color: #3443ad;}
		...
		form {display: inline; padding: 0px;margin: 0px;}
		 .button{
		 	cursor: pointer;
		 	background-image: url("web/imgs/button_normarl.jpg");
		 	width: 102px;
		 	height: 35px;
		 	border: 0px solid #fff;
		 	line-height: 35px;	
...
<body>
	...
	<div id="emplist">
		<form action="" method="post">
			<table width="550s" height="30" border="1" align="center"  cellpadding="0" cellspacing="0">
				<tr>
					...
					<s:iterator value="#request.pv.pageList">
						...
						<tr><td colspan="8" align="right"><input type="checkbox" class="style_box"/>全选/取消&nbsp;&nbsp;
							<input type="submit" value="删除信息" onmouseover="buttonHover(this)"
									onmouseout="buttonNormal(this)" class="button" style="border: 0px solid #fff;" onclick="alert('删除成功'); return false;"/>&nbsp;</td></tr>
			</table>		
		</form>	
		<center>
