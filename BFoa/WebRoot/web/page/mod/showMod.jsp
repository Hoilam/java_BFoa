...
<body>
	...
	<table width="600" height="395">
		...
		<tr>
			<td height="35px" width="140"></td>
			<td width="110" style="height:35px;line-height: 35px;" align="left" valign="top">
			<div class="button" onmouseover="buttonHover(this,'web/')" onmouseout="buttonNormal(this,'web/')" onclick="openModa|Window('addmodule.html',315,170)"> 
			添加模块
			</div>
			</td>
